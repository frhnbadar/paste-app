...
const Navbar = () => {
  ...
  <div className="md:hidden relative">
    <button className="text-gray-300 hover:text-cyan-300 focus:outline-none">
    ...
    <div className="absolute right-0 mt-2 w-40 bg-gray-900 rounded-md shadow-lg flex flex-col gap-y-2 p-4 z-50 hidden">
      {NavbarData.map((link, idx) => (
        <NavLink
          key={idx}
          to={link.path}
