...
const ViewPaste = () => {
  ...
  return (
    <div className=" text-white w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-5 items-start">
        ...
        >
          ...
          >
            ...
            {/* Circle and copy btn */}
            <div
              className={`text-white w-fit rounded-t flex items-center justify-between gap-x-4 px-4`}
            >
              {/*Copy  button */}
              <button
